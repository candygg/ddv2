...
bot = telebot.TeleBot('8186143877:AAE1yfsDpC2-vC737bbrQap-ZvHkTr8xnZc')
# Admin user IDs
admin_id = ["5616232839","6903781705"]
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You are not authorised to use this bot:- @KvnAlpha ❄."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command.                                                                          DM FOR GET ACCESS:- @KvnAlpha")
